    ...
    if codigo_final_digitado.strip():
      ...
      if colunas_possiveis:
        ...
        if bobina_encontrada is not None:
          ...
          st.markdown(
              """
            <div style="background-color: #064e3b; border: 2px solid #10b981; padding: 20px; border-radius: 12px; color: #ffffff; margin-top: 15px;">
                ...
                <div style="font-size: 26px; font-weight: bold; background: #022c22; padding: 12px; border-radius: 8px; text-align: center; margin-bottom: 15px; letter-spacing: 2px; font-family: monospace;">
                    """
              + str(codigo_confirmado)
              + """
                </div>
                
                <p style="margin: 5px 0; font-size: 15px;"><b>Manifesto:</b> """
              + str(navio_selecionado)
              + """</p>
                <p style="margin: 5px 0; font-size: 15px;"><b>Item:</b> """
              + str(item)
              + """ | <b>BL:</b> """
              + str(bl)
              + """</p>
                <p style="margin: 5px 0; font-size: 15px;"><b>Cliente:</b> """
              + str(cliente)
              + """</p>
                <p style="margin: 5px 0; font-size: 15px;"><b>Destino:</b> """
              + str(destino)
              + """</p>
                <p style="margin: 5px 0; font-size: 15px;"><b>Peso Líq:</b> """
              + str(peso_liq)
              + """t | <b>Peso Brut:</b> """
              + str(peso_brut)
              + """t</p>
          ...
          st.markdown(
              """
            <div style="background-color: #7f1d1d; border: 2px solid #ef4444; padding: 20px; border-radius: 12px; color: #ffffff; margin-top: 15px;">
