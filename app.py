...
def ler_etiqueta_com_ia(imagem_pil):
    ...
    # Reduz a largura máxima para 1000 pixels (perfeito para OCR/Visão sem pesar)
    max_largura = 1000
    ...
    # Comprime para JPEG com qualidade 80 (mantém a leitura nítida e derruba o tamanho para ~500kb)
    buffered = io.BytesIO()
