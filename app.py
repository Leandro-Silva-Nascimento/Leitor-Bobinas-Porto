...
# --- INJEÇÃO FORÇADA DE ÍCONES (COM FORÇAGEM DE CACHE) ---
st.markdown(
    """
    <link rel="manifest" href="/app/static/manifest.json">
    <link rel="apple-touch-icon" href="/app/static/icon-192.png?v=2">
    <link rel="apple-touch-icon" sizes="512x512" href="/app/static/icon-512.png?v=2">
