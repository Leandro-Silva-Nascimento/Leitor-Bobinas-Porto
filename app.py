...
def ler_etiqueta_com_ia(imagem_pil):
  ...
  # Reduz a imagem proporcionalmente mantendo a nitidez para etiquetas longas
  max_largura = 1200  # Aumentamos levemente para garantir leitura perfeita de etiquetas maiores
  ...
  # Prompt flexível para capturar códigos curtos ou longos de qualquer fornecedor
  prompt = (
